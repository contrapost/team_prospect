...
class GroupMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_member" do
    assert_difference('GroupMember.count') do
      post group_members_url, params: { group_member: { description: @group_member.description, email: @group_member.email, first_name: @group_member.first_name, last_name: @group_member.last_name, link: @group_member.link, phone: @group_member.phone } }
    end
  ...
  test "should update group_member" do
    patch group_member_url(@group_member), params: { group_member: { description: @group_member.description, email: @group_member.email, first_name: @group_member.first_name, last_name: @group_member.last_name, link: @group_member.link, phone: @group_member.phone } }
